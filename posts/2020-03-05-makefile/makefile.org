...
_DISCLAIMER:_ I am by no means an expert in writing makefiles. And if
...
the results reported on the data should be considered /stale/. Changes to data
...
[[https://www.gnu.org/software/make/manual/html_node/index.html#Top][Make]] is a application often used to compile other larger and complex
...
#+begin_src dot :file ./images/makefile_process_1.png :exports results :eval yes :cache yes
digraph graphname { D [label="data.csv"]; P [label="stats.py"]; O
[label="output.csv"];

    D->P; P->O; } 
#+end_src

#+RESULTS[24fc643d1cbfae54c6453dd1d0bc0d06a1c0ac10]:
[[file:./images/makefile_process_1.png]]
...
#+begin_src dot :file ./images/makefile_process_2.png :exports results :eval yes :cache yes
digraph graphname { D [label="data.csv"]; P1 [label="algorithm_1.py"];
P2 [label="algorithm_2.py"]; O1 [label="output_1.csv"]; O2
[label="output_2.csv"];

    D->P1->O1; D->P2->O2; } 
#+end_src

#+RESULTS[1568ac68dd605bc37a5f1505ff0434eb2f9c4773]:
[[file:./images/makefile_process_2.png]]
...
#+begin_src dot :file ./images/makefile_process_3.png :exports results :eval yes :cache yes
digraph graphname { D1 [label="data.csv"]; A1
[label="algorithm_1.py"]; A2 [label="algorithm_2.py"]; D2
[label="squares.cpp"]; D3 [label="squared_data.csv"]; A3
[label="algorithm_3.py"]; O1 [label="output_1.csv"]; O2
[label="output_2.csv"]; O3 [label="output_3.csv"];

    D1->A1->O1; D1->A2->O2; D1->D2->D3->A3->O3; }
#+end_src

#+RESULTS[e59b4c78bec08c2b443bc6026941c3b04e9eb162]:
[[file:./images/makefile_process_3.png]]
...
produce output_3.csv. To automate this process, we will add the following rule
to our makefile:
...
#+begin_src dot :file ./images/makefile_process_4.png :exports results :eval yes :cache yes
digraph graphname { D1 [label="data.csv"]; A1
[label="algorithm_1.py"]; A2 [label="algorithm_2.py"]; D2
[label="squares.cpp"]; D3 [label="squared_data.csv"]; A3
[label="algorithm_3.py"]; O1 [label="output_1.csv"]; O2
[label="output_2.csv"]; O3 [label="output_3.csv"];
    ...
    D1->A1->O1; D1->A2->O2; D3->A2; D1->D2->D3->A3->O3; } 
#+end_src

#+RESULTS[7e20a23458ea9cc13a39c4961bb0f218be14a6be]:
[[file:./images/makefile_process_4.png]]
...
#+begin_src dot :file ./images/makefile_process_5.png :exports results :eval yes :cache yes
digraph graphname {
    D1 [label="data.csv"];
    A1 [label="algorithm_1.py"]; 
    A2 [label="algorithm_2.py"]; 
    D2 [label="squares.cpp"];
    D3 [label="squared_data.csv"];
    A3 [label="algorithm_3.py"];
    O1 [label="output_1.csv"];
    O2 [label="output_2.csv"];
    O3 [label="output_3.csv"];
    
    S1 [label="summarise.py"];
    FO [label="final_results.csv"];
...
#+RESULTS[6310dc3f9000ed89e0a7f932b94c8a3e1cf70eec]:
[[file:./images/makefile_process_5.png]]
...
[[http://pgfplots.sourceforge.net/pgfplotstable.pdf][PGFPlotstable]] is a very
...
In a makefile, using
[[https://ftp.gnu.org/old-gnu/Manuals/make-3.79.1/html_chapter/make_6.html][variables]] may overcome this limitation. Let's begin by first defining a number of variables
...
#+begin_src dot :file ./images/makefile_process_6.png :exports results :eval yes :cache yes
digraph graphname {
    D1 [label="data.csv"];
    A1 [label="algorithm_1.py"]; 
    A2 [label="algorithm_2.py"]; 
...
#+RESULTS[ecd838c9ad10692d043276fa49b5c3216c6183f1]:
[[file:./images/makefile_process_6.png]]
